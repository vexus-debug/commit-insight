...
const ways = [
  {
    ...
    desc: "Your financial contribution directly funds rehabilitation programs, eye surgeries, and equipment for blind patients.",
  },
  {
    icon: Users,
    title: "Volunteer Your Time",
    desc: "Share your skills and time with our rehabilitation center — from teaching to administrative support.",
  },
  {
    icon: Gift,
    title: "Sponsor a Person",
    desc: "Sponsor the full rehabilitation of a visually impaired individual through our 1-2 year program.",
  },
  {
    icon: Handshake,
    title: "Partner With Us",
    desc: "Organizations and businesses can partner with TLEC for greater impact through corporate social responsibility.",
  },
];
  ...
  <div>
    ...
    <section className="py-20">
      <div className="container grid md:grid-cols-2 gap-12 items-center">
        ...
        <img src={hero3} alt="TLEC beneficiary" className="rounded-2xl shadow-xl w-full" />
      </div>
    </section>
