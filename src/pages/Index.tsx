              ...
              <Reveal direction="left" className="md:col-span-2">
                <div className="relative group">
                  ...
                  <div className="relative rounded-3xl overflow-hidden shadow-2xl ring-1 ring-white/10">
                    <img src={profAdedayo} alt="Prof. Adedayo Adio" className="w-full h-[320px] md:h-[420px] object-cover object-top group-hover:scale-105 transition-transform duration-700" />
