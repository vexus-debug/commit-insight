            ...
            <Reveal direction="left">
              <div className="relative">
                ...
                <div className="relative rounded-[2rem] overflow-hidden shadow-2xl">
                  <img src={hero5} alt="TLEC Team at work" className="w-full aspect-[4/5] object-cover" />
                </div>
                {/* Floating stat */}
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            ...
            <Reveal direction="left" delay={0.1}>
              <div className="group relative rounded-3xl overflow-hidden h-full">
                <div className="absolute inset-0">
                  <img src={gallery3} alt="The Lens Eye Clinic" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            ...
            <Reveal direction="right" delay={0.2}>
              <div className="group relative rounded-3xl overflow-hidden h-full">
                <div className="absolute inset-0">
                  <img src={gallery9} alt="TLEC Rehabilitation Center" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                  <div className="absolute inset-0 bg-primary/35" />
                  <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/90 to-primary/30" />
                </div>
                <div className="relative z-10 p-8 md:p-10 flex flex-col justify-end min-h-[400px] md:min-h-[480px]">
            ...
            <Reveal direction="left" className="md:col-span-2">
              <div className="relative group sticky top-24">
                ...
                <div className="relative rounded-[2rem] overflow-hidden shadow-2xl ring-1 ring-border/20">
                  <img src={profAdedayo} alt="Prof. Adedayo Adio" className="w-full aspect-[3/4] object-cover object-top group-hover:scale-[1.03] transition-transform duration-700" />
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-3">
                  <div className="rounded-2xl overflow-hidden aspect-[3/4]">
                    <img src={hero7} alt="Board activities" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="rounded-2xl overflow-hidden aspect-square">
                    <img src={gallery1} alt="Community work" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                </div>
                <div className="space-y-3 pt-8">
                  <div className="rounded-2xl overflow-hidden aspect-square">
                    <img src={gallery5} alt="Training" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                  <div className="rounded-2xl overflow-hidden aspect-[3/4]">
                    <img src={gallery3} alt="Eye clinic" className="w-full h-full object-cover hover:scale-105 transition-transform duration-500" />
                  </div>
                </div>
              </div>
            </Reveal>
